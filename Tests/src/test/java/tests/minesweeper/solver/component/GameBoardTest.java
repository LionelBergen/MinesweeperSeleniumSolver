...
public class GameBoardTest {
	...
	public void testIsTouchingSameSpot() {
		GameSquare square1 = new GameSquare(null, null, 5, 5);
		GameSquare square2 = new GameSquare(null, null, 5, 5);
	...
	public void testIsTouchingLeftRight() {
		GameSquare square1 = new GameSquare(null, null, 5, 5);
		GameSquare square2 = new GameSquare(null, null, 4, 5);
	...
	public void testIsTouchingTopBottom() {
		GameSquare square1 = new GameSquare(null, null, 5, 6);
		GameSquare square2 = new GameSquare(null, null, 5, 5);
	...
	public void testIsTouchingTopLeftCornerBottomRightCorner() {
		GameSquare square1 = new GameSquare(null, null, 5, 5);
		GameSquare square2 = new GameSquare(null, null, 4, 4);
